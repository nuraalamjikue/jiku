...
<script src="js/s_form.js"></script>
<script src="js/s_js.js"></script>
<body>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td><table width="650" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="142" height="121" align="center" valign="middle" bgcolor="#EEEEEE" class="left_round"><img src="img/index.png" width="82" height="82"></td>
              ...
              <tr>
                <td align="right"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="right" valign="top"><img src="img/index.jpg" width="220" height="41" hspace="0" vspace="0" border="0" ></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                      ...
                      <table width="100%" border="0" cellpadding="3" cellspacing="0" class="black12bold">
                        ...
                        <tr>
                          ...
                          <td align="right" valign="middle"><select name="year" class="textfield05" id="year">
                            <option value="0000" selected>Select One</option><option value="2016">2016</option><option value="2015">2015</option><option value="2014">2014</option><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option>
                          </select></td>
                          <td align="left" valign="middle">&nbsp;</td>
                        </tr>
                        <tr>
            ...
            <tr>
              <td><table width="626"  border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="356" height="70" align="left" valign="middle" bgcolor="#F2F2F2" class="footer_text">&copy;2005-2016  Ministry of Education, All rights reserved.</td>
                  ...
                  <td width="110" height="70" align="center" valign="middle" bgcolor="#F2F2F2"><img src="img/tbl_logo.png" width="83" height="44"></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="3">
      <tr class="black11">
        <td width="24%" align="left" valign="middle"><a href="https://play.google.com/store/apps/details?id=com.govt.educationboardresult"><img src="images/play.png" width="150" height="47" alt=""/></a></td>
        <td width="27%" align="center" valign="middle">Public Result on Android<br><img src="images/android.png" width="18" height="20" alt=""/><br>
          It's completely free!</td>
        <td width="49%" align="right" valign="middle">Last Update 11 May 2016 &nbsp;</td>
        </tr>
    </table></td>
  </tr>
  <tr>
